...
titleZh: "空间转录组数据（SiT）上自监督学习方法的系统比较"
summaryZh: "在小鼠脑部空间转录组数据上，对 8 种自监督学习方法与 3 种图神经网络架构进行系统评估。"
...
**Interpretation Challenges**: High Moran's I could reflect beneficial spatial structure or excessive smoothing. High Silhouette doesn't guarantee biological relevance. So these metrics mainly surface differences in the learned representations; they do not settle which method is better.
...
2. Can we design metrics that track biological utility, not just statistical properties?
