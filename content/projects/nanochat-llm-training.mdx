...
titleZh: "从零构建一个 ChatGPT：深入大语言模型训练全流程"
summaryZh: "完整走通分词、预训练、分布式训练与微调流程，在 112 亿 token 上训练一个 5.61 亿参数的对话模型，以理解现代语言模型的各个环节。"
...
repoUrl: "https://github.com/Thewhey-Brian/nanochat/tree/master"
demoUrl: "https://huggingface.co/spaces/BrianGuo/nanochat-20b-chat"
