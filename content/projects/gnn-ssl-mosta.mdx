---
title: "Self-Supervised Learning Methods on Cross-tissue Spatial Transcriptomics Data (MOSTA)"
titleZh: "跨组织空间转录组数据（MOSTA）上的自监督学习方法评估"
summaryZh: "在大规模小鼠胚胎空间转录组数据上评估 8 种自监督方法与 3 种图神经网络架构的组合，发现基于重构的方法表现出值得注意的效果。"
